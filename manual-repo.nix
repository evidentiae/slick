# this file must still be generated manually.  
{
  ...
  "artifacts" = {
    ...
    "nix-public/org/scala-sbt/sbt/1.2.3/sbt-1.2.3.pom" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/sbt/1.2.3/sbt-1.2.3.pom";
      sha256 = "13ifxrn36d70w6z9im1yqfgmf9x735g2pdg05iqp3v97jbrzgs1a";
    };
    "nix-public/org/scala-sbt/sbt/1.2.3/sbt-1.2.3.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/sbt/1.2.3/sbt-1.2.3.jar";
      sha256 = "104bwmiy3iv2j3yb79apy677n2zb9mzal3n949r1ckxmnmm0qpcm";
    };
    "nix-public/org/scala-sbt/io_2.12/1.2.1/io_2.12-1.2.1.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/io_2.12/1.2.1/io_2.12-1.2.1.jar";
      sha256 = "0ah3jaxz0p3jarl4kj1b6fs11sbnfw3as5j9zraaqciiqp0hpjd1";
    };
    "nix-public/org/scala-sbt/util-logging_2.12/1.2.2/util-logging_2.12-1.2.2.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/util-logging_2.12/1.2.2/util-logging_2.12-1.2.2.jar";
      sha256 = "0sphiv59yjizc57mv4h2jg6w34831iyk337ynlbsr7dzmiy46029";
    };
    "nix-public/org/scala-sbt/librarymanagement-core_2.12/1.2.1/librarymanagement-core_2.12-1.2.1.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/librarymanagement-core_2.12/1.2.1/librarymanagement-core_2.12-1.2.1.jar";
      sha256 = "0n20748p78xr43n4sqy8pvz2y6p41nav2mdmv7rwbsl09qyjsccm";
    };
    "nix-public/org/scala-sbt/librarymanagement-ivy_2.12/1.2.1/librarymanagement-ivy_2.12-1.2.1.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/librarymanagement-ivy_2.12/1.2.1/librarymanagement-ivy_2.12-1.2.1.jar";
      sha256 = "0njkxihpf8drd0d812wdrw90bkvf4hyf96c3vf1lbhrkmipaizr1";
    };
    "nix-public/org/scala-sbt/compiler-interface/1.2.2/compiler-interface-1.2.2.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/compiler-interface/1.2.2/compiler-interface-1.2.2.jar";
      sha256 = "10v6if6l2cxs4nlqhfd3c42l8s5fvhsdq5416sws83cd8fc0m04h";
    };
    "nix-public/org/scala-sbt/zinc-compile_2.12/1.2.2/zinc-compile_2.12-1.2.2.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/zinc-compile_2.12/1.2.2/zinc-compile_2.12-1.2.2.jar";
      sha256 = "0v7ggskwy0ip9mdzsfm73ghrd7f2kf387iy69jqglcpfnsm83vgl";
    };
    "nix-public/org/scala-sbt/scripted-sbt-redux_2.12/1.2.3/scripted-sbt-redux_2.12-1.2.3.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/scripted-sbt-redux_2.12/1.2.3/scripted-sbt-redux_2.12-1.2.3.jar";
      sha256 = "07sjwjbfzcdl70g1arhbajnpjxd63x8iasqlixsf1cra62rpxx99";
    };
    "nix-public/org/scala-sbt/scripted-plugin_2.12/1.2.3/scripted-plugin_2.12-1.2.3.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/scripted-plugin_2.12/1.2.3/scripted-plugin_2.12-1.2.3.jar";
      sha256 = "0cmfgdg6gdca4jq7gjgln116gdj3s0b8vga0k9vqy22ksc0m8wa0";
    };
    ...
    "nix-public/org/scala-lang/scala-library/2.12.6/scala-library-2.12.6.pom" = {
      url = "http://central.maven.org/maven2/org/scala-lang/scala-library/2.12.6/scala-library-2.12.6.pom";
      sha256 = "1cd0xaxzyj932rj1c9s56b573lr9j3cg7ipnf0ik6y4pkgq2wmxq";
    };
    ...
    "nix-public/org/scala-sbt/main_2.12/1.2.3/main_2.12-1.2.3.jar" = {
      url = "http://central.maven.org/maven2/org/scala-sbt/main_2.12/1.2.3/main_2.12-1.2.3.jar";
      sha256 = "1kknk4i0pfczgn9iqkkyaf5kyihplj1mdfbw1lmf0vyxydx4a1x6";
    };
    "nix-public/org/apache/logging/log4j/log4j-api/2.8.1/log4j-api-2.8.1.jar" = {
      url = "http://central.maven.org/maven2/org/apache/logging/log4j/log4j-api/2.8.1/log4j-api-2.8.1.jar";
      sha256 = "18hza4bf33kl8w4pjdfpyfdmj516w6ja9flrdpczf9hk9dvan18j";
    };
    "nix-public/org/apache/logging/log4j/log4j-core/2.8.1/log4j-core-2.8.1.jar" = {
      url = "http://central.maven.org/maven2/org/apache/logging/log4j/log4j-core/2.8.1/log4j-core-2.8.1.jar";
      sha256 = "0vk1cklax9g1f1hdgp1yfbaz6kb82i25ks7g5rk1794h1vi76nl1";
    };
    "nix-public/org/apache/logging/log4j/log4j-slf4j-impl/2.8.1/log4j-slf4j-impl-2.8.1.jar" = {
      url = "http://central.maven.org/maven2/org/apache/logging/log4j/log4j-slf4j-impl/2.8.1/log4j-slf4j-impl-2.8.1.jar";
      sha256 = "1dmkggbf6w1gii4v0vwh3i1r874l2y048agsaijpk4hmgfxjbws3";
    };
  };
}
